...
// Don't include admin_header.php since we're in user folder
?>
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-light shadow-sm">
        <div class="container-fluid">
            ...
            <div class="navbar-brand d-flex flex-column align-items-start">
                ...
                <span class="text-muted fs-6">News & Updates Admin</span>
            </div>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarGenTri">
                <ul class="navbar-nav mb-2 mb-lg-0 align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold" href="admin_stories.php">Stories Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold" href="admin_partners.php">Partners Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold active" href="submit_news.php">News Admin</a>
                    </li>
                </ul>
            </div>
        </div>
